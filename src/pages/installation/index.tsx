...
`}
        ...
        <BodyMedium>
          Browse the <code>src/styles</code> folder for the CSS files. You will find this:
        </BodyMedium>
...
`}
        ...
        <BodyMedium>
          These are the most important files for your project. You can use them as you want. So, imagine you have a React or Next.js project, go to <code>styles/</code>, delete all the base CSS files in it and copy all the files from this framework. And after that happened, go to your <code>_app.tsx</code> file and add the following lines:
        </BodyMedium>
...
export default function App({ Component, pageProps }: AppProps) {
  ...
  <BodyMedium>
    The order is really important. We need to import the <code>root.css</code> file first, then the <code>normalizer.css</code> file, and then the <code>generics.css</code> file. After that, we can import the media queries files. The order is important because we need to override the styles from the previous files. So, if you want to override the styles from the <code>root.css</code> file, you need to import the <code>root.css</code> file first, and then other files.
  </BodyMedium>

  <BodyMedium>
    After that, you can use a <code>custon.css</code> file where you can add your own styles. This file will be imported after the <code>xxl.css</code> file. Because of inheritance, this file must be the latest to be imported.
  </BodyMedium>

  <BodyMedium>
    Once your setup, in your first view, you should see changes. Write a <code>DIV</code> element with a <code>className='border-dp'</code> and you should see the framework in action:
  </BodyMedium>
